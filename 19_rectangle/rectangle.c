...
rectangle_t intersection(rectangle_t r1, rectangle_t r2) {
  ...
  if (r1.x + r1.width < r2.x || r2.x + r2.width < r1.x || r1.y + r1.height < r2.y ||
    ...
    rec_intersect.x = 0;
    rec_intersect.y = 0;
    rec_intersect.height = 0;
    rec_intersect.width = 0;
    return rec_intersect;
  }
  else {
    rec_intersect.x = max(r1.x, r2.x);
    rec_intersect.y = max(r1.y, r2.y);
    rec_intersect.width = min(r1.x + r1.width, r2.x + r2.width) - rec_intersect.x;
    rec_intersect.height = min(r1.y + r1.height, r2.y + r2.height) - rec_intersect.y;
    return rec_intersect;
  }
}
